...
class DatasetImportModel(Base):
    ...
    rights_status = Column(String, nullable=False, default="attested")
    evidence_tier = Column(String, nullable=False, default="unresolved")
    view_type = Column(String, nullable=False, default="unknown")
    import_metadata = Column(JSONB, nullable=False, default=dict)
...
class DatasetItemModel(Base):
    ...
    duplicate_group_id = Column(String, index=True, nullable=True)
    source_type = Column(String, nullable=False, default="other")
    source_reference = Column(String, nullable=True)
    rights_status = Column(String, nullable=False, default="attested")
    evidence_tier = Column(String, nullable=False, default="unresolved")
    view_type = Column(String, nullable=False, default="unknown")
    historical_label = Column(String, nullable=True)
    audit_not_before = Column(DateTime, nullable=True)
...
class AnnotationEventModel(Base):
    ...
    visual_verdict = Column(String, nullable=True)
    evidence_tier = Column(String, nullable=True)
    reason_codes = Column(JSONB, nullable=False, default=list)
    requested_evidence = Column(JSONB, nullable=False, default=list)
...
class DatasetConsensusModel(Base):
    ...
    training_role = Column(String, nullable=True)
    evidence_tier = Column(String, nullable=True)
    audit_status = Column(String, nullable=False, default="pending")
    subclass_eligible = Column(Boolean, nullable=False, default=False)
